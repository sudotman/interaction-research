...
namespace Oculus.Interaction.Input
{
    public class AnimatedHandOVR : MonoBehaviour
    {
        ...
        [SerializeField]
        private bool stateForCustomHand;
        ...
        private void UpdateCapTouchStates()
        {
            ...
            if (_allowThumbUp == AllowThumbUp.Never)
            {
        ...
        private void UpdateAnimStates()
        {
            ...
            else
            {
                ...
                _pointBlend = Mathf.Clamp01(_pointBlend);
                //Debug.LogError("point: " + _pointBlend + " slideBlend: " + _slideBlend + " thumbsUp: " + _thumbsUpBlend + "flexAnim: " + _animFlex + "pinch Anim: " + _animPinch );
